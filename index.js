...
console.log(createMenuItem("French Fries", 5, "Dinner"));
console.log(createMenuItem("Cookie", 2, "Snacks"));
console.log(createMenuItem("Ice Cream", 2, "Dessert"));
